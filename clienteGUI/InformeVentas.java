...
public class InformeVentas extends javax.swing.JInternalFrame {
    ...
    public InformeVentas() throws Exception {
        initComponents();

        this.getContentPane().setBackground(new Color(72, 70, 92));
        modeloDespachos = new DefaultTableModel();

        modeloDespachos.addColumn("Id Venta");
        modeloDespachos.addColumn("Nombre Cliente");
        modeloDespachos.addColumn("Pack");
        modeloDespachos.addColumn("Fecha Venta");
        modeloDespachos.addColumn("Fecha Entrega");
        modeloDespachos.addColumn("Precio");
...
//    }
    ...
    private void initComponents() {
        ...
        InformeVentas1 = new com.toedter.calendar.JDateChooser();
        BuscarInformeComuna = new javax.swing.JButton();
        InformeVentas2 = new com.toedter.calendar.JDateChooser();
        ...
        jLabel7.setText("Busqueda de Ventas");
        ...
        InformeVentas1.setFocusable(false);
        InformeVentas1.addContainerListener(new java.awt.event.ContainerAdapter() {
            public void componentRemoved(java.awt.event.ContainerEvent evt) {
                InformeVentas1ComponentRemoved(evt);
            }
        });
        InformeVentas1.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                InformeVentas1FocusLost(evt);
            }
        });
        ...
        InformeVentas2.setFocusable(false);
        InformeVentas2.addContainerListener(new java.awt.event.ContainerAdapter() {
            public void componentRemoved(java.awt.event.ContainerEvent evt) {
                InformeVentas2ComponentRemoved(evt);
            }
        });
        InformeVentas2.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                InformeVentas2FocusLost(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(InformeVentas1, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jLabel8)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(txtRutBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(InformeVentas2, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 331, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(InformeVentas1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel9)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(InformeVentas2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel10))
                        .addGap(28, 28, 28))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void InformeVentas1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_InformeVentas1FocusLost


    }//GEN-LAST:event_InformeVentas1FocusLost
    ...
    private void BuscarInformeComunaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarInformeComunaActionPerformed
        ...
        Date date = InformeVentas1.getDate();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
        String fechaVenta1 = (String.valueOf(sdf.format(date)));
        Date date1 = InformeVentas2.getDate();
        ...
        try {
            ...
            String sql = ("SELECT\n"
                    ...
                    + "    p.pack_costo\n"
                    + "FROM venta v\n"
                    + "INNER JOIN cliente c on v.CLI_ID_CLIENTE = c.id_cliente\n"
                    + "INNER JOIN pack p on v.PCK_ID_PACK = p.id_pack\n"
                    + "WHERE v.VTA_FECHA_VENTA BETWEEN '"+fechaVenta1+"' AND '"+fechaVenta2+"' and c.cli_rut = '"+txtRutBuscar.getText()+"'");
...
//                if (respuesta1.getInt("EST_ID_ESTADO") == 1) {
                Object[] dato = {
                    respuesta1.getInt("vta_id_venta"),
                    respuesta1.getString("cli_nombre")+" "+
                    respuesta1.getString("cli_apellido"),
                    respuesta1.getString("pack_nombre"),
                    respuesta1.getString("vta_fecha_venta"),
                    respuesta1.getString("vta_fecha_entrega"),
                    (respuesta1.getInt("pack_costo"))*1,3};
...
//                }
    ...
    private void InformeVentas1ComponentRemoved(java.awt.event.ContainerEvent evt) {//GEN-FIRST:event_InformeVentas1ComponentRemoved

    }//GEN-LAST:event_InformeVentas1ComponentRemoved

    private void InformeVentas2ComponentRemoved(java.awt.event.ContainerEvent evt) {//GEN-FIRST:event_InformeVentas2ComponentRemoved
        // TODO add your handling code here:
    }//GEN-LAST:event_InformeVentas2ComponentRemoved

    private void InformeVentas2FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_InformeVentas2FocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_InformeVentas2FocusLost
    ...
    private com.toedter.calendar.JDateChooser InformeVentas1;
    private com.toedter.calendar.JDateChooser InformeVentas2;
